...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        ## SET ==> WINDOW TITLE
        self.setWindowTitle('GSG-5/6 to Skydel convertor')
        UIFunctions.labelTitle(self, 'GSG-5/6 to Skydel convertor')
        # UIFunctions.labelDescription(self, 'Convertor page')
        ## ==> END ##
    ...
    def load_GSG56_scenarios(self):
        ...
        if self.load_gsg56_scenarios_folder == "":
            ...
            # self.screen_1(self.load_gsg56_scenarios_folder)
    ...
    def Button(self):
        ...
        if btnWidget.objectName() == "btn_load_gsg5_6":
            ...
            UIFunctions.labelPage(self, "Load GSG-5/6 files")
    ...
    def GSG56_page_mainFunction(self):
        ...
        try:
            self.GSG56_scenarios = pathlib.Path(self.load_GSG56_scenarios())
        ...
        try:
            for file_item in self.GSG56_scenarios.iterdir():
                if file_item.is_file():
                    ...
                    print(split_item_path)
                    item_name = split_item_path[0]
                    item_extension = split_item_path[1]
                    print(item_extension)
    ...
    def skydel_page_mainFunction(self):
        ...
        if self.gsg56_selection == 1:
            try:
                ...
                print(attr_err_100)
                QMessageBox.about(self, "GSG-5/6 configuration",
                                  "Please check that you selected a GSG5/6 scenario on the Load GSG-5/6 files page")
        else:
            QMessageBox.about(self, "GSG-5/6 configuration",
                              "Please check that you selected a GSG5/6 scenario on the Load GSG-5/6 files page")
    ...
    def create_skydel_py(self, scen_dict):
        ...
        try:
            ...
            if self.ui.skydel_GN_checkBox.isChecked() == True:
                GAUSSIAN_NOISE = True
            ...
            if not self.scen_file_item:
                QMessageBox.about(self, " GSG-5/6 scenario errors",
                                  " Please make sure your selected a .scen filein the page Load GSG-5/6 Files.")
            else:
            ...
            if RADIO_TYPE == "NoneRT" or RADIO_TYPE == "None":
                ...
                print(signal_upper_band, 5)
                print(signal_lower_band, 6)
                print(signal_lower_band2, 7)
                print(signal_lower_band_E6, 8)
                ...
                if not signal_upper_band:
                    ...
                    self.python_script.write("\n")
                    print(new_dict_sky_py['Signals_UpperLBand_none'])

                    # sim.call(ChangeModulationTargetSignals(0, 1250000, 125000000, "UpperL", signal_upper_band, -1, False, "uniqueId", None))
                ...
                if not signal_lower_band:
                    ...
                    self.python_script.write("\n")
                    print(new_dict_sky_py['Signals_LowerLBand_none'])
                ...
                if not signal_lower_band2:
                    ...
                    self.python_script.write("\n")
                    print(new_dict_sky_py['Signals_LowerLBand2_none'])
                ...
                if not signal_upper_band:
                    ...
                    # sim.call(ChangeModulationTargetSignals(0, 1250000, 85000000, "UpperL", signal_upper_band, 50, True,
                    # "uniqueId", None))
                ...
                if not signal_lower_band:
                    ...
                    # sim.call(ChangeModulationTargetSignals(0, 1250000, 85000000, "LowerL", signal_lower_band, 50, True,
                    # "uniqueId2", None))
                ...
                print("Signals:", signal_upper_band)

                # ChangeModulationTargetSignals(0, 12500000, 125000000, "UpperL", "L1CA", 50, True, "{351cf00f-e6fe-4b27-b44a-3d6cf0a99c40}", None)
                # Change configuration before starting the simulation
    ...
    def playback_skydel_mainFunction(self):
        ...
        if not self.scen_file_item:
            QMessageBox.about(self, "GSG-5/6 Scenarios",
                              "No .scen file was selected. Please go to the page Load GSG-5/6 scenarios to load .scen file.")
        else:
            self.scen_dict_py = scen_func.scen_main(self.scen_file_item, RADIO_TYPE)
        ...
        try:
            ...
            # {"CmdName": "SetVehicleAntennaOffset", "CmdUuid": "{75523135-c55b-4ed4-a41b-cc4ee4135003}", "X": 10, "Y": 20,
            # "Z": 30, "Yaw": 0, "Pitch": 0, "Roll": 0, "Name": "Basic Antenna"}
            ...
            if not lever_arm_param:
                ...
                print("lever arm values:", lever_arm_x, lever_arm_y, lever_arm_z)
            ...
            print(ecef_pos, ecef_pos_x, ecef_pos_y, ecef_pos_z)
            ...
            if str(traj_type) == "Static" or str(traj_type) == "3GPP":
                ...
                #                   '"{my_id_50}"' + "," + '"Type": ' + '"Circular"' + "," + '"Lat": ' + str(
                #     start_pos_lat) \
                ...
                if self.nmea_file_item:
                    ...
                    if len_lines == 1:
                        ...
                        print(
                            "NO RMC file was found, Change the time in the Skydel instance or Skydel will start at the default time")
                    ...
                    QMessageBox.about(self, "MISSING NMEA FILE ERROR", "An NMEA file was expected, but it was not found in the selected folder. Therefore the default vehicle position will be applied. You can put the NMEA file in the same folder as your current scenario and restart the convertor.")
    ...
    def create_skydel_sdx(self, scen_dict):
        ...
        script_header_sdr = "{" + '"CmdName": ' + '"New",' + '"CmdUuid": ' + '"{my_id_0}"' + "," + '"DiscardCurrentConfig": ' + "true" + "," + '"LoadDefaultConfig": ' + "true" + "}"
        ...
        # self.sdx_script.write(pos_type_str)
        # self.sdx_script.write("\n")
        ...
        if RADIO_TYPE == "None":
            ...
            print(signal_lower_band)

            signal_lower_band2 = new_dict_sky_py['Signals_LowerLBand2_none']
            print(signal_lower_band2)

            signal_lower_band_E6 = new_dict_sky_py['Signals_LowerLBandE6_none']
            print(signal_lower_band_E6)
            ...
            # Change configuration before starting the simulation
            if signal_upper_band != "":
                # {"CmdName": "SetModulationTarget","CmdUuid": "{8dd3937e-37df-45a3-a957-9d40b046f6a3}","Type": "NoneRT","Path": "","Address": "","ClockIsExternal": true,"Id": "{c6aaf761-5b49-44ad-961f-6686fe9812a5}"}
                ...
                # {"CmdName": "ChangeModulationTargetSignals", "CmdUuid": "{876616af-ce55-4fb7-84e4-e7af79142578}",
                # "Output": 0, "MinRate": 1250000, "MaxRate": 125000000, "Band": "UpperL", "Signal": "L1CA", "Gain": 0,
                # "GaussianNoise": false, "Id": "{c6aaf761-5b49-44ad-961f-6686fe9812a5}"}
        ...
        if RADIO_TYPE == "DTA-2116":
            ...
            # Change configuration before starting the simulation
            if signal_upper_band != "":
                # {"CmdName": "SetModulationTarget", "CmdUuid": "{424cb15f-0768-482d-9194-de93c046e7f1}", "Type": "DTA-2116", "Path": "", "Address": "", "ClockIsExternal": true,"Id": "{e3f29eb0-4c7c-44ec-b313-ade78248061b}"}
                # {"CmdName": "SetModulationTarget","CmdUuid": "{8dd3937e-37df-45a3-a957-9d40b046f6a3}","Type": "NoneRT","Path": "","Address": "","ClockIsExternal": true,"Id": "{c6aaf761-5b49-44ad-961f-6686fe9812a5}"}
                ...
                # {"CmdName": "ChangeModulationTargetSignals", "CmdUuid": "{796f9266-b7c5-4c98-a013-f6b495a624f7}",
                # "Output": 0, "MinRate": 12500000, "MaxRate": 125000000, "Band": "UpperL",
                # "Signal": "L1CA,L1C,L1P,L1ME,G1,E1,E1PRS,B1,B1C", "Gain": 50, "GaussianNoise": true,
                # "Id": "{e3f29eb0-4c7c-44ec-b313-ade78248061b}"}
            ...
            # Change configuration before starting the simulation
            if signal_lower_band != "":
                # {"CmdName": "SetModulationTarget", "CmdUuid": "{c811d429-6b35-4882-88ef-ae57595028e0}", "Type": "DTA-2116", "Path": "", "Address": "", "ClockIsExternal": true, "Id": "{da8ee213-1645-43c5-805c-6e163093b13e}"}
                # {"CmdName": "SetModulationTarget","CmdUuid": "{8dd3937e-37df-45a3-a957-9d40b046f6a3}","Type": "NoneRT","Path": "","Address": "","ClockIsExternal": true,"Id": "{c6aaf761-5b49-44ad-961f-6686fe9812a5}"}
                ...
                # {"CmdName": "ChangeModulationTargetSignals", "CmdUuid": "{2add000b-b2e8-442c-a06a-253050f68b43}",
                # "Output": 0, "MinRate": 12500000, "MaxRate": 125000000, "Band": "LowerL",
                # "Signal": "L2C,L2P,L2ME,L2MR,L5,G2,E5a,E5b,B2a,SBASL5,QZSSL2C,QZSSL5,QZSSL5S,NAVICL5", "Gain": 50,
                # "GaussianNoise": true, "Id": "{da8ee213-1645-43c5-805c-6e163093b13e}"}

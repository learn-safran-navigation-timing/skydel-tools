...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.edit_tau0 = QtWidgets.QLineEdit(self.frame_2)
        self.edit_tau0.setObjectName("edit_tau0")
        self.edit_tau0.setAlignment(QtCore.Qt.AlignCenter)  # <-----
        self.edit_tau0.setText("1")
        self.edit_tau0.textChanged.connect(self.update_slider_tau0)

        self.gridLayout_2.addWidget(self.edit_tau0, 7, 0, 1, 1)
        ...
        self.edit_s4 = QtWidgets.QLineEdit(self.frame_2)
        self.edit_s4.setAlignment(QtCore.Qt.AlignCenter)  # <-----
        self.edit_s4.setObjectName("edit_s4")
        self.edit_s4.setText("0.5")
        self.edit_s4.textChanged.connect(self.update_slider_s4)

        self.gridLayout_2.addWidget(self.edit_s4, 4, 0, 1, 1)
        ...
        self.slider_s4 = QtWidgets.QSlider(self.frame_2)
        self.slider_s4.setOrientation(QtCore.Qt.Horizontal)
        self.slider_s4.setObjectName("slider_s4")

        self.slider_s4.setRange(0, 100)
        self.slider_s4.setValue(50)
        self.slider_s4.setSingleStep(1)
        self.slider_s4.setPageStep(10)
        self.slider_s4.setTickPosition(QSlider.TickPosition.TicksAbove)
        self.slider_s4.valueChanged.connect(self.update_s4)
        self.gridLayout_2.addWidget(self.slider_s4, 3, 0, 1, 1)

        self.slider_tau0 = QtWidgets.QSlider(self.frame_2)
        self.slider_tau0.setStyleSheet("")
        self.slider_tau0.setOrientation(QtCore.Qt.Horizontal)
        self.slider_tau0.setObjectName("slider_tau0")

        self.slider_tau0.setRange(0, 200)
        self.slider_tau0.setValue(100)
        self.slider_tau0.setSingleStep(2)
        self.slider_tau0.setPageStep(20)
        self.slider_tau0.setTickPosition(QSlider.TickPosition.TicksAbove)
        self.slider_tau0.valueChanged.connect(self.update_tau0)

        self.gridLayout_2.addWidget(self.slider_tau0, 6, 0, 1, 1)
        ...
        self.slider_cn0 = QtWidgets.QSlider(self.frame_content_wid_1)
        self.slider_cn0.setOrientation(QtCore.Qt.Horizontal)
        self.slider_cn0.setObjectName("slider_cn0")

        self.slider_cn0.setRange(35, 55)
        self.slider_cn0.setValue(45)
        self.slider_cn0.setSingleStep(1)
        self.slider_cn0.setPageStep(10)
        self.slider_cn0.setTickPosition(QSlider.TickPosition.TicksAbove)
        self.slider_cn0.valueChanged.connect(self.update_cn0)
        self.verticalLayout_5.addWidget(self.slider_cn0)

        self.lineEdit = QtWidgets.QLineEdit(self.frame_content_wid_1)
        self.lineEdit.setObjectName("lineEdit")
        self.lineEdit.setAlignment(QtCore.Qt.AlignCenter)  # <-----
        self.lineEdit.setText("45")
        self.lineEdit.textChanged.connect(self.update_slider_cn0)
        ...
        self.edit_len_s = QtWidgets.QLineEdit(self.frame_content_wid_3)
        self.edit_len_s.setObjectName("edit_len_s")
        self.edit_len_s.setText("300")

        self.gridLayout_5.addWidget(self.edit_len_s, 1, 1, 1, 1)
        ...
        self.pushButton.clicked.connect(self.SimCallback)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Scintillator"))
    ...
    def update_s4(self, value):
        self.edit_s4.setText(str(value / 100))

    def update_tau0(self, value):
        self.edit_tau0.setText(str(value / 100))

    def update_cn0(self, value):
        self.lineEdit.setText(str(value))

    def update_slider_s4(self, value):
        try:
            if float(value) > 1 or int(value) > 1:
                self.edit_s4.setText("1")
                self.slider_s4.setValue(1)

            elif float(value) < 0 or int(value) < 0:
                self.edit_s4.setText("0")
                self.slider_s4.setValue(0)
            else:
                self.slider_s4.setValue(int(float(value) * 100))

        except ValueError as val_err_1:
            print(val_err_1)

    def update_slider_tau0(self, value):
        try:
            if float(value) > 2 or int(value) > 2:
                self.edit_tau0.setText("2")
                self.slider_tau0.setValue(2)
            elif float(value) < 0 or int(value) < 0:
                self.edit_tau0.setText("0")
                self.slider_tau0.setValue(0)
            else:
                self.slider_tau0.setValue(int(float(value) * 100))
    ...
    def update_slider_cn0(self, value):
        try:
            if int(value) > 55:
                self.lineEdit.setText("55")
                self.slider_cn0.setValue(55)

            elif int(value) < 35:
                self.lineEdit.setText("35")
                self.slider_cn0.setValue(35)
            else:
                self.slider_cn0.setValue(int(value))
    ...
    def SimCallback(self):
        ...
        if mode == "Simulate":
            ...
            self.Tsim = int(str(self.edit_len_s.text()))
            self.Tb = 0.02
            self.Ta = int(self.comboBox.currentText())/1000
            self.tau0 = self.edit_tau0.text()
            self.S4 = float(self.edit_s4.text())

...
class UBXMessage:
    ...
    def _do_attributes(self, **kwargs):
        ...
        try:
            ...
            print(err)
            print("Incorrect type for attribute ", {key})
            print("in", {['GET', 'SET', 'POLL'][self._mode]}, "message")
            print("class", {self.identity})
    ...
    def identity(self) -> str:
        ...
        try:
            ...
            print("Unknown UBX message type class:", str(err))
            # raise ube.UBXMessageError(
    ...
    def cfgkey2name(keyID: int) -> tuple:
        ...
        for key, val in ubcdb.UBX_CONFIG_DATABASE.items():
            ...
            # else:
            #     print(key,typ)
            #     print("Undefined configuration database key:", keyID, {hex(keyID)})

        print("Undefined configuration database key", hex(keyID))

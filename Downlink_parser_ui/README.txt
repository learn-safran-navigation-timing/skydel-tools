...
This folder contains a UI for the utility scripts to parse downlink navigation messages.
...
See section below for more information regarding the downlink parser.

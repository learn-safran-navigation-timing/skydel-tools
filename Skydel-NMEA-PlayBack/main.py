...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def start(self):
        ...
        if folder_selection == 0:
            ...
            try:
                ...
                gga_time_fieldnames_1 = ['True date', 'Calculated date', 'True seconds', 'Calculated seconds']

                self.rmc_filename = self.save_folder + "/" + 'RMC' + '.csv'
                self.gga_time_filename = self.save_folder + "/" + 'GGA_Time' + '.csv'
                self.gga_time_filename_1 = self.save_folder + "/" + 'GGA_Time_1' + '.csv'

                self.rmc_file_open = open(self.rmc_filename, 'a', newline='')
                self.rmc_csvfile_writer = csv.DictWriter(self.rmc_file_open, fieldnames=rmc_fieldnames)
                self.rmc_csvfile_writer.writeheader()

                self.gga_time_open = open(self.gga_time_filename, 'a', newline='')
                self.gga_time_writer = csv.DictWriter(self.gga_time_open, fieldnames=gga_time_fieldnames)
                self.gga_time_writer.writeheader()

                self.gga_time_open_1 = open(self.gga_time_filename_1, 'a', newline='')
                self.gga_time_writer_1 = csv.DictWriter(self.gga_time_open_1, fieldnames=gga_time_fieldnames_1)
                self.gga_time_writer_1.writeheader()
                ...
                self.gsa_file_open = open(self.gsa_filename, 'a', newline='')
                ...
                self.gsv_file_open = open(self.gsv_filename, 'a', newline='')
                ...
                try:
                        ...
                        try:
                            try:
                                ...
                                if msg.sentence_type == 'GGA':
                                    ...
                                    self.ind_gga = self.ind_gga + 1
                                else:
                                    self.save_parsed_data(msg)
                            except AttributeError as attr_err_1:
                                print(attr_err_1)
                    ...
                    self.gga_time_open.close()
                    self.gga_time_open_1.close()
        ...
        try:
            ...
            if msg.sentence_type == 'GGA':
                ...
                if str(gga_timestamp) == "None":
                    ...
                    #
                    # if gga_lat == '' or gga_lon is None:
                    #     gga_lat = 0
                    # if gga_lon == '' or gga_altitude is None:
                    #     gga_lon = 0
                    # if gga_altitude == '' or gga_altitude is None:
                    #     gga_altitude = 0
                    #
                    # if gga_altitude != 0:
                    #     if gga_lon != 0:
                    ...
                    #                 gga_altitude = 0
                    #             elif str(gga_altitude) == "None":
                    #                 gga_altitude = 0
                    #
                    #             self.table_gga_lat.append(gga_lat)
                    #             self.table_gga_lon.append(gga_lon)
                    #
                    #             if str(gga_lat) == "0":
                    #                 print(gga_lat)
                    #                 gga_lat = self.table_gga_lat[self.cnt_gga - 1]
                    #             elif str(gga_lat) == "None":
                    #                 gga_lat = self.table_gga_lat[self.cnt_gga - 1]
                    #
                    #             if str(gga_lon) == "0":
                    #                 print(gga_lon)
                    #                 gga_lon = self.table_gga_lon[self.cnt_gga - 1]
                    #             elif str(gga_lon) == "None":
                    #                 gga_lon = self.table_gga_lon[self.cnt_gga - 1]
                    #
                    #             self.traj_csvfile_writer.writerow(
                    #                 {'Elapsed time (ms)': self.default_timestamp, 'TimeStamp': gga_timestamp,
                    #                  'Latitude': gga_lat,
                    #                  'Longitude': gga_lon,
                    #                  'Antenna Alt above sea level (mean)': gga_altitude})
                    #
                    #             self.default_timestamp += 100
                    pass
                else:
                    ...
                    if float(gga_total_millisec) == 0.0:
                        ...
                        print("table elapsed:", self.table_gga_elapsed, self.ind_gga)
                        print("Indice:", self.ind_gga)

                        gga_start_time = self.table_gga_elapsed[0]
                        ...
                        if self.elapsed_gga <= 0:
                            #self.elapsed_gga = gga_total_millisec - self.table_gga_elapsed[self.ind_gga]
    ...
    def playback_skydel_2(self):
        ...
        try:
            ...
            if not self.list_GNSS_ID:
                ...
                if self.global_output_val == "None":
                    self.sim.call(SetModulationTarget("None", "", "", True, "uniqueId0"))
                    self.sim.call(
                    ...
                    self.sim.call(SetModulationTarget("NoneRT", "", "", True, "uniqueId0"))
                    self.sim.call(
                    ...
                    self.sim.call(SetModulationTarget("DTA-2115B", "", "", True, "uniqueId0"))
                    self.sim.call(
                    ...
                    self.sim.call(SetModulationTarget("DTA-2116", "", "", True, "uniqueId0"))
                    self.sim.call(
        ...
        except TypeError as typ_err_10:
            QMessageBox.about(self, "Parsing error",
                              str(typ_err_10))
